...
namespace ROOT {
   static TClass *vectorlETAnalysisSIMCgR_Dictionary();
   static void vectorlETAnalysisSIMCgR_TClassManip(TClass*);
   static void *new_vectorlETAnalysisSIMCgR(void *p = 0);
   static void *newArray_vectorlETAnalysisSIMCgR(Long_t size, void *p);
   static void delete_vectorlETAnalysisSIMCgR(void *p);
   static void deleteArray_vectorlETAnalysisSIMCgR(void *p);
   static void destruct_vectorlETAnalysisSIMCgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<TAnalysisSIMC>*)
   {
      vector<TAnalysisSIMC> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<TAnalysisSIMC>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<TAnalysisSIMC>", -2, "vector", 477,
                  typeid(vector<TAnalysisSIMC>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlETAnalysisSIMCgR_Dictionary, isa_proxy, 0,
                  sizeof(vector<TAnalysisSIMC>) );
      instance.SetNew(&new_vectorlETAnalysisSIMCgR);
      instance.SetNewArray(&newArray_vectorlETAnalysisSIMCgR);
      instance.SetDelete(&delete_vectorlETAnalysisSIMCgR);
      instance.SetDeleteArray(&deleteArray_vectorlETAnalysisSIMCgR);
      instance.SetDestructor(&destruct_vectorlETAnalysisSIMCgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<TAnalysisSIMC> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const vector<TAnalysisSIMC>*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlETAnalysisSIMCgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<TAnalysisSIMC>*)0x0)->GetClass();
      vectorlETAnalysisSIMCgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlETAnalysisSIMCgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<TAnalysisSIMC> : new vector<TAnalysisSIMC>;
   }
   static void *newArray_vectorlETAnalysisSIMCgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<TAnalysisSIMC>[nElements] : new vector<TAnalysisSIMC>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlETAnalysisSIMCgR(void *p) {
      delete ((vector<TAnalysisSIMC>*)p);
   }
   static void deleteArray_vectorlETAnalysisSIMCgR(void *p) {
      delete [] ((vector<TAnalysisSIMC>*)p);
   }
   static void destruct_vectorlETAnalysisSIMCgR(void *p) {
      typedef vector<TAnalysisSIMC> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<TAnalysisSIMC>
