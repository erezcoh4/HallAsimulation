...
namespace ROOT {
   static TClass *TCalcSIMC_Dictionary();
   static void TCalcSIMC_TClassManip(TClass*);
   ...
   {
      ::TCalcSIMC *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::TCalcSIMC));
      static ::ROOT::TGenericClassInfo 
         instance("TCalcSIMC", "TCalcSIMC.h", 33,
                  typeid(::TCalcSIMC), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &TCalcSIMC_Dictionary, isa_proxy, 4,
                  sizeof(::TCalcSIMC) );
   ...
   // Dictionary for non-ClassDef classes
   static TClass *TCalcSIMC_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::TCalcSIMC*)0x0)->GetClass();
      TCalcSIMC_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   ...
   static void *new_TCalcSIMC(void *p) {
      return  p ? new(p) ::TCalcSIMC : new ::TCalcSIMC;
   }
   static void *newArray_TCalcSIMC(Long_t nElements, void *p) {
      return p ? new(p) ::TCalcSIMC[nElements] : new ::TCalcSIMC[nElements];
   }
   // Wrapper around operator delete
   static void delete_TCalcSIMC(void *p) {
      delete ((::TCalcSIMC*)p);
...
class __attribute__((annotate("$clingAutoload$TCalcSIMC.h")))  TCalcSIMC;
)DICTFWDDCLS";
